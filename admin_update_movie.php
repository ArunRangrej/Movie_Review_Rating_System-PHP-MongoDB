...
if(isset($_SESSION['admin']))
{
  ...
  if(isset($_POST['submit']))
  {
    ...
    $bulk->update( ['title'=>$title],
            ...
            'rating_review'=>['imdb_review'=>['rating'=>$imdb_rating] , 'tomato_review'=>['rating'=>$tomato_rating]]
            ]]);
...
<ul class="nav navbar-nav navbar-right">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Update Movie HERE </h3>
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> Uodate Movie </button>    
      </div>
